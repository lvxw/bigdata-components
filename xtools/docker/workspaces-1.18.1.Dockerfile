...
COPY /dependency/workspaces-${COMPONENT_VERSION}/kasm_release_service_images_amd64_1.18.1.tar.gz /usr/local/src/kasm_release/
COPY /dependency/workspaces-${COMPONENT_VERSION}/kasm_release_workspace_images_amd64_1.18.1.tar.gz /usr/local/src/kasm_release/
