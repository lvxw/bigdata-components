...
COPY /dependency/hadoop-${HADOOP_VERSION}/hadoop-env.sh /usr/local/hadoop-${HADOOP_VERSION}/etc/hadoop/
...
COPY /dependency/hadoop-${HADOOP_VERSION}/yarn-env.sh /usr/local/hadoop-${HADOOP_VERSION}/etc/hadoop/
