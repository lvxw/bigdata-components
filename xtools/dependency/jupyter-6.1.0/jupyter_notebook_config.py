...
#  password.
#  Default: ''
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$6KhOVYO8vPjjYWFLU2BBSA$fxH9OyDl7qHTwYp2YYrg7QMuV85atytxlnZu6yh6L7U'
...
#  Choices: any of ['md5', 'blake2b', 'sha224', 'sha512', 'sha3_512', 'sha1', 'sha384', 'sha3_384', 'sha3_224', 'sha256', 'blake2s', 'sha3_256']
#  Default: 'sha256'
