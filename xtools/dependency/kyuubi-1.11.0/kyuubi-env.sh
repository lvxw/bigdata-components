...
export FLINK_HADOOP_CLASSPATH="${HADOOP_HOME}/share/hadoop/client/hadoop-client-api-3.1.4.jar:${HADOOP_HOME}/share/hadoop/client/hadoop-client-runtime-3.1.4.jar"
